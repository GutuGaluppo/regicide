 ...
 * mesmo tamanho dos avatares e badge de mensagens não lidas. No mobile, um
 * rótulo de guia (ActionHint) explica o ícone na primeira sessão.
 */
export const ChatButton = () => {
	...
	return (
		<View>
			...
			<ActionHint label={t("chat.title")} placement="above" />
		</View>
	);
};
