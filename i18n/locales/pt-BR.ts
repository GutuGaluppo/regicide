const ptBR = {
	...
	multiplayer: {
		...
		status: {
			...
			yourTurn: "Sua vez",
			playNow: "Jogue agora",
			waitingForAction: "Aguardando a resolução da jogada",
			waitingInline: "está jogando...",
			activeShort: "na vez",
			waitingShort: "aguardando",
			you: "você",
			cards: "cartas",
			handSummary: "Mão {{current}}/{{max}}",
			order: "{{index}}",
		},
		abandon: {
	...
	lobby: {
		...
		avatarDescription: "Selecione um avatar para te representar na sala.",
