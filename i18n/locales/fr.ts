...
const fr: Translations = {
	...
	multiplayer: {
		...
		status: {
			...
			waitingForAction: "En attente de la résolution de l'action",
			waitingInline: "est en train de jouer...",
			activeShort: "actif",
			waitingShort: "en attente",
			you: "vous",
			cards: "cartes",
			handSummary: "Main {{current}}/{{max}}",
			order: "{{index}}",
		},
		abandon: {
	...
	lobby: {
		...
		avatarDescription: "Sélectionnez un avatar pour vous représenter dans la salle.",
		confirmAvatar: "Confirmer",
		...
		shareTitle: "Regicide — Salle multijoueur",
		shareMessage:
			"Viens jouer à Regicide avec moi ! Code de la salle : {{code}}\n{{url}}",
