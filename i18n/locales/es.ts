...
const es: Translations = {
	...
	multiplayer: {
		...
		status: {
			...
			yourTurn: "Tu turno",
			playNow: "Juega ahora",
			waitingForAction: "Esperando a que se resuelva la jugada",
			waitingInline: "está jugando...",
			activeShort: "activo",
			waitingShort: "esperando",
			you: "tú",
			cards: "cartas",
			handSummary: "Mano {{current}}/{{max}}",
			order: "{{index}}",
		},
		abandon: {
	...
	lobby: {
		...
		avatarDescription: "Selecciona un avatar para representarte en la sala.",
		confirmAvatar: "Confirmar",
