...
const en: Translations = {
	...
	multiplayer: {
		...
		status: {
			...
			yourTurn: "Your turn",
			playNow: "Play now",
			waitingForAction: "Waiting for the move to resolve",
			waitingInline: "is playing...",
			activeShort: "active",
			waitingShort: "waiting",
			you: "you",
			cards: "cards",
			handSummary: "Hand {{current}}/{{max}}",
			order: "{{index}}",
		},
		abandon: {
			title: "Abandon game?",
	...
	lobby: {
		...
		avatarDescription: "Pick an avatar to represent you in the room.",
		confirmAvatar: "Confirm",
		cancelAvatar: "Cancel",
		...
		shareBtn: "Share code",
		shareTitle: "Regicide — Multiplayer room",
		shareMessage:
			"Come play Regicide with me! Room code: {{code}}\n{{url}}",
